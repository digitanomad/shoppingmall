	...
	<div id="bookUpdateForm" class="box">
		<ul>
            ...
            <li><label for="book_title">제목</label>
				<input id="book_title" name="book_title" type="text" size="50" maxlength="50" value="${book.bookTitle}">
				<input type="hidden" name="book_id" value="${book_id}">
			<li><label for="book_price">가격</label>
				<input id="book_price" name="book_price" type="text" size="10" maxlength="9" value="${book.bookPrice}">원
      		<li><label for="book_count">수량</label>
          		<input id="book_count" name="book_count" type="text" size="10" maxlength="5" value="${book.bookCount}">권
      		...
      		<li><label for="publishing_com">출판사</label>
          		<input id="publishing_com" name="publishing_com" type="text" size="20" maxlength="30" value="${book.publishingCom}">  
			...
			<li><label for="book_image">책 이미지</label>
				<input id="book_image" name="book_image" type="file">${book.bookImage}  
			<li><label for="book_content">내용</label>
          		<textarea id="book_content" name="book_content" rows="13" cols="50">${book.bookContent}</textarea>
      		<li><label for="discount_rate">할인율</label>
          		<input id="discount_rate" name="discount_rate" type="text" size="5" maxlength="2" value="${book.discountRate}">  
      		<li class="label2">
